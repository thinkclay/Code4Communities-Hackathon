...
abstract class SR_SQLConn extends MySQLi {
	...
	public function __construct() {
		...
		parent::__construct( SR_DB_CONNECT_HOST, SR_DB_CONNECT_USER, SR_DB_CONNECT_PASS, SR_DB_CONNECT_DBNAME );
	...
	public function submitErrorLog( $SQLKey = null, $description = '' ) {
		...
		$query	=	'
			INSERT INTO		' . SR_ERROR_LOG_TABLE . '
